   ...
   <?php
                ...
                <div class="row no-gutters row-bordered row-border-light">
                    ...
                    <form method="POST" action="profile_handler.php" style="width:50%;">
                                ...
                                <div class="tab-pane fade active show" id="account-general">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value style="background-color: transparent;" name="name" placeholder="<?php echo $_SESSION['cname']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" style="color: #0ef;">E-mail</label>
                                            <input type="text" class="form-control mb-1" value style="background-color: transparent;" name="email" placeholder="<?php echo $_SESSION['cemail']; ?>">
                                ...
                                <div class="tab-pane fade" id="account-info">
                                    <div class="card-body pb-2">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="address" style="background-color: transparent;" placeholder="<?php echo $_SESSION['caddress']; ?>"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label class="form-label" style="color: #0ef;">Area</label>
                                            <select class="custom-select" name="area">
                                                <option <?php echo ($_SESSION['carea'] == 'Chattagram') ? 'selected' : ''; ?>>Chattagram</option>
                                                <option <?php echo ($_SESSION['carea'] == 'Dhaka') ? 'selected' : ''; ?>>Dhaka</option>
                                                <option <?php echo ($_SESSION['carea'] == 'Khulna') ? 'selected' : ''; ?>>Khulna</option>
                                                <option <?php echo ($_SESSION['carea'] == 'Barishal') ? 'selected' : ''; ?>>Barishal</option>
                                                <option <?php echo ($_SESSION['carea'] == 'Sylhet') ? 'selected' : ''; ?>>Sylhet</option>
                                                <option <?php echo ($_SESSION['carea'] == 'Rajshahi') ? 'selected' : ''; ?>>Rajshahi</option>
                                                <option <?php echo ($_SESSION['carea'] == 'Mymensingh') ? 'selected' : ''; ?>>Mymensingh</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value style="background-color: transparent;" name="phone" placeholder="<?php echo $_SESSION['cphone']; ?>">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="text-right mt-3">
                            <button type="submit" class="btn btn-primary" style="margin-right: 30%;" name="save">Save changes</button>&nbsp;
                        </div>
    ...
    <div class="profile_div">
        ...
        <div class="transparent-box">
            <ul>
                <li><a href="customer_profile.php" target="_parent" style="color: red;">profile</a></li>
